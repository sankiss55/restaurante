...
@Roles(RolesList.ADMIN)    
    ...
    @ApiOperation({
        ...
        description: "Retorna las mesas que el mesero está atendiendo",
        tags: ['Mesas']
    })
...
@Roles(RolesList.ADMIN)
    ...
    @ApiOperation({
        ...
        description: "Retorna todas las mesas que no están siendo atendidas",
        tags: ['Mesas']
    })
    async ObtenerMesasDisponibles(): Promise<MesasEntitie[]> {
        return await this.MesasService.ObtenerMesasDisponibles();
    }

    @Roles(RolesList.MESERO)
    @Patch("asignar/:idMesa/:idUsuario")
    @ApiOperation({
        summary: "Asignar mesa a mesero",
        description: "Asigna una mesa disponible al mesero actual",
        tags: ['Mesas']
    })
    async AsignarMesa(
        ...
        return await this.MesasService.AsignarMesaAlMesero(idMesa, idUsuario);
    }
}