...
const Dashboard: React.FC = () => {
  const { } = useAuth(); // logout no se usa aquí // We might move logout to the Sidebar in real implementations
        ...
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-10 h-10 rounded-full bg-gray-200 overflow-hidden shadow-sm ring-2 ring-white">
              ...
              <img src="https://ui-avatars.com/api/?name=Admin&background=4F6A50&color=fff" alt="User Avatar" className="w-full h-full object-cover" />
            </div>
          </div>
        </header>
